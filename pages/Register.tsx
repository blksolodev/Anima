...
export const Register: React.FC = () => {
  ...
  // Automatically redirect when user is detected in store
  // The store uses onSnapshot, so it will update as soon as the user doc is created below
  useEffect(() => {
    if (user) {
      navigate('/');
    }
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // This will trigger the onSnapshot listener in useAuthStore
